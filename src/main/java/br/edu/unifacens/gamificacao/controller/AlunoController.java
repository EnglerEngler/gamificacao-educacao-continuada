...
public class AlunoController {
    ...
    public AlunoResponse criar(@Valid @RequestBody CriarAlunoRequest request) {
    ...
    @Operation(summary = "Registra a conclusão de curso e aplica as recompensas das US01 e US03")
    public AlunoResponse concluir(
